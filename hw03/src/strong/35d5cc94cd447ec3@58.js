...
function _livePlaceColumn(userdata,livePlace){return(
userdata.map(row => row[livePlace])
)}

function _livePlaceUnique(livePlaceColumn){return(
[...new Set(livePlaceColumn)].sort()
)}

function _livePlaceCounts(livePlaceUnique,livePlaceColumn){return(
livePlaceUnique.map(val => ({
  value: val,
  count: livePlaceColumn.filter(v => v === val).length
}))
)}

function _minidata(livePlaceCounts){return(
livePlaceCounts.flatMap((item, index) => ([
  {
    value: item.value,
    count: item.count,
    series: 'LivePlace'
...
function _choropleth(taiwanMap){return(
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("livePlaceColumn")).define("livePlaceColumn", ["userdata","livePlace"], _livePlaceColumn);
  main.variable(observer("livePlaceUnique")).define("livePlaceUnique", ["livePlaceColumn"], _livePlaceUnique);
  main.variable(observer("livePlaceCounts")).define("livePlaceCounts", ["livePlaceUnique","livePlaceColumn"], _livePlaceCounts);
  main.variable(observer("minidata")).define("minidata", ["livePlaceCounts"], _minidata);
  ...
  main.variable(observer("choropleth")).define("choropleth", ["taiwanMap"], _choropleth);
  return main;
}
