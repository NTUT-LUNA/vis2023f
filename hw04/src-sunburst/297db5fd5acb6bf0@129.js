...
function _sunburst(partition,data,d3,radius,innerCircleQuestion,outerCircleQuestion,width,color,arc,mousearc,reducePackage,recycleMaterials,saveEnergy,workshopIntroduction,replaceAreaIntroduction,museumIntroduction)
{
  ...
  svg
    ...
    .on("mouseenter", (event, d) => {
      ...
      if(d.data.name === "工作室") {
        div
          .html(workshopIntroduction);
      }
      else if(d.data.name === "替代空間")
      {
        div
          .html(replaceAreaIntroduction);
      }
      else if(d.data.name === "美術館")
      {
        div
          .html(museumIntroduction);
      }
      else
      {
        div.html("");
...
function _reducePackage(){return(
...
function _recycleMaterials(){return(
...
function _workshopIntroduction(){return(
...
function _replaceAreaIntroduction(){return(
...
function _museumIntroduction(){return(
...
md`# credit 
- [HW04](https://observablehq.com/d/c84affd948a1e733)`
)}
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("viewof sunburst")).define("viewof sunburst", ["partition","data","d3","radius","innerCircleQuestion","outerCircleQuestion","width","color","arc","mousearc","reducePackage","recycleMaterials","saveEnergy","workshopIntroduction","replaceAreaIntroduction","museumIntroduction"], _sunburst);
  ...
  main.variable(observer("reducePackage")).define("reducePackage", _reducePackage);
  main.variable(observer("recycleMaterials")).define("recycleMaterials", _recycleMaterials);
  main.variable(observer("saveEnergy")).define("saveEnergy", _saveEnergy);
  main.variable(observer("workshopIntroduction")).define("workshopIntroduction", _workshopIntroduction);
  main.variable(observer("replaceAreaIntroduction")).define("replaceAreaIntroduction", _replaceAreaIntroduction);
  main.variable(observer("museumIntroduction")).define("museumIntroduction", _museumIntroduction);
