...
function _strong_data(data)
{
  data.children = data.children.filter(child => child.Group == 15);
...
md`[credit](https://observablehq.com/d/aac31303c5de2ce5)`
)}
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("strong_data")).define("strong_data", ["data"], _strong_data);
